...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Orders not Received yet</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Orders Received</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Orders delivered</p>
                      </div>
