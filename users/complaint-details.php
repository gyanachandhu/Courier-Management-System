...
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Order Number : </b></label>
          		<div class="col-sm-4">
...
<!-- <label class="col-sm-2 col-sm-2 control-label"><b>Sub Category :</b> </label>
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Order Type :</b></label>
              <div class="col-sm-4">
              <p><?php echo htmlentities($row['complaintType']);?></p>
              </div>
<label class="col-sm-2 col-sm-2 control-label"><b>Company :</b></label>
              <div class="col-sm-4">
  ...
  <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Name of the product :</b></label>
              <div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Order Details </label>
              <div class="col-sm-10">
