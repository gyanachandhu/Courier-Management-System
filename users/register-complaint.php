...
$complainno=$cmpn;
echo '<script> alert("Your Order has been successfully Placed and your Order number is  "+"'.$complainno.'")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>DH | User Register Order</title>
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Place your Order</h3>
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> Parcel</option>
                  <!-- <option value="General Query">Parcel</option> -->
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Name of the product</label>
<div class="col-sm-4">
<input type="text" name="noc" placeholder="Product Name" required="required" value="" required="" class="form-control">
</div>

</div>

<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Product Details (max 2000 words) </label>
<div class="col-sm-6">
<textarea  name="complaindetails" required="required" cols="10" rows="10" placeholder="Enter product details like cost" class="form-control" maxlength="2000"></textarea>
</div>
</div>
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Product Related Doc(if any) </label>
<div class="col-sm-6">
