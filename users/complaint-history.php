...
<?php include("includes/sidebar.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i>Your Order History</h3>
		  		<div class="row mt">
			  		<div class="col-lg-12">
                              ...
                              <tr>
                                 ...
                                 ?></td>
                                  <td align="center"><?php 
                                    ...
                                    { ?>
                                      <button type="button" class="btn btn-theme04">Not Received Yet</button>
                                   <?php }
 if($status=="in process"){ ?>
<button type="button" class="btn btn-warning">Order Received</button>
<?php }
if($status=="closed") {
?>
