...
<div class="controls">
<input type="text" placeholder="Enter Company Name"  name="state" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<td>
											<a href="edit-state.php?id=<?php echo $row['id']?>" ><i class="icon-edit"> edit</i></a>
											<a href="state.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="icon-remove-sign"> delete</i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
