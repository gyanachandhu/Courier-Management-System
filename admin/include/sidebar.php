...
<?php } ?>
						...
						<ul class="widget widget-menu unstyled">
                                <li><a href="category.php"><i class="menu-icon icon-tasks"></i> Add Block </a></li>
                                <!-- <li><a href="subcategory.php"><i class="menu-icon icon-tasks"></i>Add Sub-Category </a></li> -->
                                <li><a href="state.php"><i class="menu-icon icon-paste"></i>Add Company</a></li>
                          
                        
                            </ul><!--/.widget-nav-->

						<ul class="widget widget-menu unstyled">
							<li><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>Users Login</a></li>
