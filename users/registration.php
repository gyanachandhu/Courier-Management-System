...
<html lang="en">
  <head>
    ...
    <title>DH | User Registration</title>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		         <input type="text" class="form-control" placeholder="Full Name" name="fullname" required="required" autofocus>
		            <br>
		            <input type="email" class="form-control" placeholder="Enter email:example@gmail.com" id="email" onBlur="userAvailability()" name="email" required="required">
