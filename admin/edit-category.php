...
{?>
									...
									<strong>Well done! Block Updated</strong>	
...
<div class="controls">
<input type="text" placeholder="Enter Block Name"  name="category" value="<?php echo  htmlentities($row['categoryName']);?>" class="span8 tip" required>
</div>
</div>
