...
{
$errormsg="Invalid username id or Contact no";
}
}
?>
...
echo htmlentities($msg);
		        ...
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="username" placeholder="Enter email:example@gmail.com"  required autofocus>
		            <br>
